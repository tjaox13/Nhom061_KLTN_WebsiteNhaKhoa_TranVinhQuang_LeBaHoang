...
import ManagePatientUser from "../../containers/System/Admin/Receptionist/ManagePatient";
import ManageBooking from "../../containers/System/Admin/Receptionist/ManageBooking";

import { useDispatch, useSelector } from "react-redux";
import CreateBooking from "../System/Admin/Receptionist/CreateBooking";
import ManageBill from "../System/Admin/Receptionist/ManageBill";
  ...
  return useRoutes([
    {
      ...
      children: [
        ...
        {
          path: "manage-all-patient",
          element: <ManagePatientUser />,
        ...
        { path: "manage-patient", element: <ManagePatientUser /> },
        {
          path: "",
          element: (
            <Navigate
              to={
                userInfo.roleId === "R1"
                  ...
                  : "/unauthorized" // Chuyển hướng nếu roleId không hợp lệ
              }
              replace={true}
            />
          ),
    ...
    },
    {
      ...
      element: <DashboardLayout />,
      children: [
        { path: "manage-booking", element: <ManageBooking /> }, //quan ly benh nhan
        {
          path: "manage-patient",
          element: <ManagePatientUser />,
        }, //quan ly ke hoach kham benh chi rieng mot bac si do
        ...
        }, //quan ly ke hoach kham benh chi rieng mot bac si do
        {
          ...
          element: (
            <Navigate
              to="/admin-dashboard/receptionist/manage-booking"
              replace={true}
            />
          ),
        },
