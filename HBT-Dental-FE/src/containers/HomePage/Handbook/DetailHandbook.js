...
class DetailHandbook extends Component {
    ...
    render() {
        ...
        if (DataHandBook && DataHandBook.categoryData) {
            categoryValue = language === 'vi' ? DataHandBook.categoryData.value_Vi : DataHandBook.categoryData.value_En
        ...
        if (DataHandBook && DataHandBook.DoctorHandbookData && DataHandBook.DoctorHandbookData.positionData) {
            ...
            position = language === 'vi' ? DataHandBook.DoctorHandbookData.positionData.value_Vi : DataHandBook.DoctorHandbookData.positionData.value_En
                                ...
                                categories.map((item, index) => {
                                    return (
                                        <Link to={`/category-handbook/${item.keyMap}`}>
                                            <li key={index}>{language === 'vi' ? item.value_Vi : item.value_En}</li>
                                        </Link>
                                    )
                                })
                            }
